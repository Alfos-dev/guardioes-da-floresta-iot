...
├── .gitignore
│
├── bridge/                  # Servico de leitura serial -> InfluxDB
│   ├── serial_bridge.py
│   ├── Dockerfile
│   └── requirements.txt
│
├── moon/                    # Servico de fase da lua
│   ├── moon_service.py
│   ├── Dockerfile
│   └── requirements.txt
│
...
### Sensor Capacitivo de Solo — Analogico
| Sensor | ESP32 |
|--------|-------|
| VCC    | 3.3V  |
| GND    | GND   |
...
| `soil_raw` | Leitura bruta do ADC | 0-4095 |
...
- O servidor, sensores e dispositivos de visualizacao se comunicam apenas na rede local
...
Este projeto é de uso acadêmico e educacional, desenvolvido como iniciativa de apoio à agricultura local.
