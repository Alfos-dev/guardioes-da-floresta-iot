...
## 🚧 v2.0 — Em desenvolvimento (Fases 1, 2 e 3 concluídas)
...
| **Painel de Administração** | `admin_panel/` | Interface web (FastAPI + HTML/CSS/JS) para gerenciar dispositivos, editar calibração em tempo real via MQTT e visualizar dados históricos |
