...
## 🚧 v2.0 — Em desenvolvimento (Fases 1, 2, 3 e 4 concluídas)
...
| **Painel de Administração** | `admin_panel/` | Interface web (FastAPI + HTML/CSS/JS) para gerenciar dispositivos, editar calibração em tempo real via MQTT, visualizar dados históricos e **construtor de firmware customizado** (Fase 4) |
